...
function Instruction() {
    return (
        <WidthBlock style={{ height: "82vh", alignItems: "center", justifyContent: "center", gap: "8%" }}>
            <h1 style={{ fontWeight: "bold", fontSize: "1.5rem", textAlign: "center" }}>공사 중...👨🏻‍🔧<br /> 빠른 시일 내에 완성하겠습니다 💻 </h1>
            <StyledWrapper>
                <div className="main">
                    <div className="dog">
